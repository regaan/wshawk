...
class ReleaseDesktopArtifactsTests(unittest.TestCase):
    ...
    def test_index_artifacts_requires_and_indexes_each_linux_format(self):
        with tempfile.TemporaryDirectory() as directory:
            dist = Path(directory)
            for name in ("wshawk-4.0.4.AppImage", "wshawk-4.0.4.deb", "wshawk-4.0.4.pacman"):
            ...
            self.assertIn("wshawk-4.0.4.AppImage", summary_text)
    ...
    def test_release_notes_include_installers_checksums_research_and_changelog(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            names = {
                "Windows": "WSHawk Setup 4.0.4.exe",
                "Linux": "wshawk-4.0.4.AppImage",
                "macOS": "WSHawk-4.0.4.dmg",
                "Python": "wshawk-4.0.4-py3-none-any.whl",
            }
            ...
            self.assertIn("WSHawk%20Setup%204.0.4.exe", notes)
