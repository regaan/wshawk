                    ...
                    <div class="panel full-height">
                        ...
                        <div class="panel-body custom-scroll" style="padding: 0;">
                            ...
                            <div id="vuln-phases"
                                ...
                                <span id="vuln-progress-status" role="status" aria-live="polite"
                                    style="margin-left: auto; color: var(--text-muted); font-size: 11px;">Idle</span>
                            </div>
                            <div style="padding: 10px 16px; border-bottom: 1px solid var(--border-color); display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                                <select id="vuln-method" class="dropdown-select" title="Baseline request method">
                                    <option>GET</option><option>POST</option><option>PUT</option><option>PATCH</option>
                                </select>
                                <select id="vuln-location" class="dropdown-select" title="Mutation location">
                                    <option value="query">Query parameter</option>
                                    <option value="body">Form body</option>
                                    <option value="json">JSON field</option>
                                    <option value="xml">XML document (XXE)</option>
                                    <option value="header">Header</option>
                                </select>
                                <input id="vuln-parameter" type="text" value="q" placeholder="parameter / header"
                                    style="width: 150px; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius); padding: 5px 8px; color: var(--text-primary); font-size: 11px;">
                                <input id="vuln-request-body" type="text" placeholder='Optional baseline body, e.g. {"q":"baseline"}'
                                    style="flex: 1; min-width: 260px; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius); padding: 5px 8px; color: var(--text-primary); font-family: var(--font-mono); font-size: 11px;">
                            </div>
                    ...
                    <div class="panel full-height">
                        <div class="panel-header glass-header flex-between">
                            ...
                            <div style="display: flex; gap: 6px; align-items: center;">
                                ...
                                <input type="url" id="ssrf-oast-url" placeholder="OAST callback URL (required)"
                                    title="Use a unique callback URL from an OAST provider you control"
                                    style="min-width: 220px; background: var(--bg-secondary); border: 1px solid var(--border-color); border-radius: var(--radius); padding: 4px 8px; color: var(--text-primary); font-size: 11px; min-height: unset; height: 28px;">
